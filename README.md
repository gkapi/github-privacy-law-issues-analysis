...
- In folder bert-privacy-law-model/ the fine tuned BERT model used for the classification of the issues as privacy or non-privacy relevant is provided for reuse.
